  ...
  return (
    <Card sx={{ maxWidth: 345 }}>
      ...
      <CardMedia
                ...
                height="300"
                width="200"
                src={imgItem} // Chỉnh sửa dòng này để thêm ảnh từ biến imgItem
                alt="item image"
                sx={{ border: '1px solid #ccc', borderRadius: '8px' , margin: '5 5 px'}} // Thêm đối tượng CSS cho viền và bo góc
                />
